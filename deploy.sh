...
pip3 install jinja2 flask gunicorn pymysql flask_sqlalchemy flask_mail marrow.mailer flask_admin
...
cp web19.nginx /etc/nginx/sites-enabled/web19
chmod -R o+rwx /var/www/web19

# systemd web19 python 服务
